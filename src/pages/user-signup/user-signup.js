...
var UserSignupPage = /** @class */ (function () {
    function UserSignupPage(menuCtrl, navCtrl, loadingCtrl, alertCtrl, formBuilder, authProvider, camera, transfer, file) {
    ...
    UserSignupPage = __decorate([
        ...
        __metadata("design:paramtypes", [MenuController, NavController, LoadingController,
            AlertController, FormBuilder,
            AuthProvider, Camera, FileTransfer, File])
    ], UserSignupPage);
